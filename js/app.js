...
let slider_banner = new Swiper('.banner__slider', {
	autoplay: {
		delay: 5000,
	...
	// Dotts
	pagination: {
		el: '.text-banner__pagination',
		type: "fraction",
	},
	// Arrows
	navigation: {
		nextEl: '.text-banner-arrow-next , .banner-next-rotate',
		prevEl: '.text-banner-arrow-prev , .banner-prev-rotate',
	},
	/*
	breakpoints: {
		320: {
...
let slider_content1 = new Swiper('.content-slider01', {
	// autoplay: {
	// 	delay: 5000,
	// 	disableOnInteraction: false,
	// },
	...
	// Arrows
	navigation: {
		nextEl: '.slider-content-next',
		prevEl: '.slider-content-prev',
	},
	/*
	breakpoints: {
		320: {
...
let slider_content2 = new Swiper('.slider-content2__list', {
	// autoplay: {
	// 	delay: 5000,
	// 	disableOnInteraction: false,
	// },
	...
	// Arrows
	navigation: {
		nextEl: '.slider-content2-next',
		prevEl: '.slider-content2-prev',
	},
	/*
	breakpoints: {
		320: {
...
let slider_gallerTrumbs = new Swiper('.trumb-gallery__slider', {
	// autoplay: {
	// 	delay: 5000,
	// 	disableOnInteraction: false,
	// },
	...
	// Arrows
	// navigation: {
	// 	nextEl: '.gallery-main-next-rotate',
	// 	prevEl: '.gallery-main-prev-rotate',
	// },
...
let slider_galleryMain = new Swiper('.gallery-main__slider', {
	// autoplay: {
	// 	delay: 5000,
	// 	disableOnInteraction: false,
	// },
...
let slider_instagram = new Swiper('.instagram__slider', {
	// autoplay: {
	// 	delay: 5000,
	// 	disableOnInteraction: false,
	// },
...
window.onload = function (){
    ...
    function documentActions(e){
        ...
        }else if (!targetElement.closest('.menu') && document.querySelector('.menu__icon._active')) {
            body_lock(0);
            menu_close();
    ...
    // const elem = document.querySelector('input[name="range-start"]');
